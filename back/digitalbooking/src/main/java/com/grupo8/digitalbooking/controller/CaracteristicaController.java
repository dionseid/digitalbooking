...
public class CaracteristicaController {
    ...
    public ResponseEntity<Object> agregarCaracteristica(@RequestBody Caracteristica caracteristica) {
        return ResponseHandler.generateResponse("La característica se ha agregado correctamente", HttpStatus.OK,
                caracteristicaService.agregarCaracteristica(caracteristica));
    }
    ...
    public ResponseEntity<Object> buscarCaracteristica(@PathVariable Integer id) {
        ...
        if (id != null && caracteristicaService.buscarCaracteristica(id).isPresent())
            response = ResponseHandler.generateResponse("Característica encontrada", HttpStatus.OK,
                    caracteristicaService.buscarCaracteristica(id));
        else
    ...
    public ResponseEntity<Object> actualizarCaracteristica(@RequestBody Caracteristica caracteristica) {
        ...
        if (caracteristica.getId() != null
            ...
            response = ResponseHandler.generateResponse("La característica se ha actualizado correctamente",
                    HttpStatus.OK, caracteristicaService.actualizarCarateristica(caracteristica));
        else
            response = ResponseHandler.generateResponse("Característica NO encontrada", HttpStatus.NOT_FOUND, null);
    ...
    public ResponseEntity<Object> listarCaracteristicas() {
        return ResponseHandler.generateResponse("Listado de todas las características", HttpStatus.OK,
                caracteristicaService.listarCaracteristicas());
    }
}
