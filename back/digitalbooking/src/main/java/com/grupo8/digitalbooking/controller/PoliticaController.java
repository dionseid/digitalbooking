...
public class PoliticaController {
    ...
    public ResponseEntity<Object> agregarPolitica(@RequestBody Politica politica) {
        return ResponseHandler.generateResponse("La política se ha agregado correctamente", HttpStatus.OK,
    ...
    public ResponseEntity<Object> buscarPolitica(@PathVariable Integer id) {
        ...
        if (id != null && politicaService.buscarPolitica(id).isPresent())
            response = ResponseHandler.generateResponse("Politica encontrada", HttpStatus.OK,
                    politicaService.buscarPolitica(id));
        else
    ...
    public ResponseEntity<Object> actualizarPolitica(@RequestBody Politica politica) {
        ...
        if (politica.getId() != null && politicaService.buscarPolitica(politica.getId()).isPresent())
            response = ResponseHandler.generateResponse("La política se ha actualizado correctamente", HttpStatus.OK,
    ...
    public ResponseEntity<Object> listarPoliticas() {
        return ResponseHandler.generateResponse("Listado de todas las Políticas", HttpStatus.OK,
                politicaService.listarPoliticas());
    }
